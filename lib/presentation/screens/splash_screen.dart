...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    // Pindah ke MainScreen setelah splash selesai
  ...
  Widget build(BuildContext context) {
    // ✅ Bungkus dengan Scaffold agar Text memiliki konteks Material Design
    return Scaffold(
