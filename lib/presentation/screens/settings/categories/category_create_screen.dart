// lib/presentation/pages/settings/categories/category_create_screen.dart
...
class _CategoryCreateScreenState extends State<CategoryCreateScreen> {
  ...
  Widget build(BuildContext context) {
    final typeName = widget.type == 'product' ? 'Produk' : 'Jasa';
  ...
  void _saveCategory() async {
    if (_formKey.currentState!.validate()) {
      ...
      final success = await widget.controller.createCategory(category);
      ...
      if (success) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(widget.controller.error ?? 'Gagal menyimpan kategori'),
