// lib/presentation/pages/settings/services/service_create_screen.dart
import 'dart:io';
...
class _ServiceCreateScreenState extends State<ServiceCreateScreen> {
  ...
  void _saveService() async {
    if (_formKey.currentState!.validate()) {
      ...
      final success = await widget.controller.createService(service);
      ...
      if (success) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(widget.controller.error ?? 'Gagal menyimpan jasa'),
